...
public class OrderType5Fragment extends Fragment implements View.OnClickListener{
	...
	public OrderType5Fragment(GetSingleOrderResponse mSingleOrder){
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		rootView = inflater.inflate(R.layout.activity_order_type5, container, false);
		init();
		return rootView;
	}
