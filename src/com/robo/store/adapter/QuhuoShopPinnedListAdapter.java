...
public class QuhuoShopPinnedListAdapter extends BaseAdapter implements PinnedSectionListAdapter {
	...
	public QuhuoShopPinnedListAdapter(Context mContext,LayoutInflater mInflater,List<GetShopListByGoodsVO> shopList){
	...
	@Override
	public GetShopListByGoodsVO getItem(int position) {
	...
	public int getItemViewType(int position) {
		GetShopListByGoodsVO mShopBase = AllDataList.get(position);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final GetShopListByGoodsVO mShopBase = AllDataList.get(position);
		int type = mShopBase.getType();
